...
## 2.6.4
[releases](https://github.com/gateisbug/alit/releases/tag/2.6.4)
### 2025-09-10, 2.6.4 패치내역
- 신규 캐릭터 추가

## 2.6.3
[releases](https://github.com/gateisbug/alit/releases/tag/2.6.3)
### 2025-07-25, 2.6.3 패치내역
- 신규 캐릭터 추가
- 신규 장비 추가
...
- 장비설명회에서 띄어쓰기를 넣지 않아도 이름을 검색할 수 있습니다.
- 함순이 리스트에서 띄어쓰기를 넣지 않아도 이름을 검색할 수 있습니다.
- 함순이 리스트에서 대소문자 구별 없이 이름을 검색할 수 있습니다.
- 함순이 리스트에서 특수문자 없이 이름을 검색할 수 있습니다.

## 2.5.1
[releases](https://github.com/gateisbug/alit/releases/tag/2.5.1)
### 2024-12-30, 2.5.1 패치내역
- ESC 누르면 모달창 닫기
...
## 2.4.6
[releases](https://github.com/gateisbug/alit/releases/tag/2.4.6)
### 2024-10-26, 2.4.6 패치내역
- 원본 리소스 24.10.25 적용

## 2.4.5
[releases](https://github.com/gateisbug/alit/releases/tag/2.4.5)
### 2024-10-25, 2.4.5 패치내역
- 원본 리소스 24.10.23 적용

## 2.4.4
[releases](https://github.com/gateisbug/alit/releases/tag/2.4.4)
### 2024-10-24, 2.4.4 패치내역
...
## 2.3.2
[releases](https://github.com/gateisbug/alit/releases/tag/2.3.2)
### 2024-07-08, 2.3.2 패치내역
- 원본 리소스 24.07.07 반영
