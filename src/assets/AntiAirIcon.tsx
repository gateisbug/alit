...
function AntiAirIcon({ size=undefined, color="currentColor", fill="none" }:IconType) {
	return (
			...
			<g transform="translate(0.000000,128.000000) scale(0.100000,-0.100000)"
			   fill={color} stroke="none">
				<path d="M732 1104 c-5 -9 -60 -67 -122 -130 -107 -108 -114 -114 -154 -114
						...
						27 57 43 22 22 42 31 85 36 47 6 58 11 64 29 4 12 15 28 25 35 11 7 19 20 19
						29 0 9 6 21 14 27 17 14 47 92 39 100 -4 3 -21 6 -39 6 -26 0 -33 -5 -38 -25
