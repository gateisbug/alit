const event_kor = [
  ...
  "어리석은 자의 천칭", "만월이 밝아오기 전에", "핼러윈의 기우", "템페스타의 비밀 조선소", "빛을 쫓는 별의 바다"
]
...
const event = [
  ...
  "The Fools Scales Event Banner", "Effulgence Before Eclipse", "Halloween Hijinks", "Tempesta's Secret Shipyard", "Light-Chasing Sea of Stars"
]
