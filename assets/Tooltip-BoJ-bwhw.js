...
`;D.defaultProps={theme:L};const ue=i.li.attrs({className:y("Item")})`
  list-style: none;
`;function Ve({items:e,multiple:r,placeholder:a,theme:l,top:s,children:t,onChange:c,defaultValue:u,minWidth:d}){const{formRef:p,open:b,inputValue:h,onClickItem:x,onFieldClick:C}=de({items:e,multiple:r,placeholder:a,theme:l,top:s,children:t,onChange:c,defaultValue:u});return n.jsxs(oe,{ref:p,children:[n.jsxs(I,{theme:l,onClick:C,$minWidth:d,children:[h.length>0?t??h.split(",,").join(", "):n.jsx(V,{theme:l,children:a??"Please select value."}),n.jsx(Ie,{readOnly:!0,value:h})]}),n.jsx(D,{theme:l,$top:s,$open:b,children:e==null?void 0:e.map(v=>n.jsx(ue,{onClick:()=>{x(v)},children:v.label??v.value},`select-item-${v.value}`))})]})}Object.assign(Ve,{Form:oe,Field:I,Placeholder:V,Box:D,Item:ue,clickAway:se,hook:de});const De={surface:{light:"var(--surface, rgba(0, 0, 0, 0.11))",dark:"var(--surface, rgba(255, 255, 255, 0.13))"}},qe=m("skeleton"),q=i.span.attrs({className:qe("root")})`
  display: block;
  min-width: 1rem; /* 16 */
  min-height: 1rem; /* 16 */
...
`;_.defaultProps={theme:he};const W=i.textarea.attrs({className:ge("root")})`
  display: inline-block;
  box-sizing: border-box;
  background-color: transparent;
  color: inherit;
...
`;W.defaultProps={rows:F.rows,theme:he};function Ye({rows:e=F.rows,onChange:r,theme:a,autoResize:l=F.autoResize,maxHeight:s,...t}){const{internalRef:c,resizeInChange:u}=pe({onChange:r,autoResize:l,maxHeight:s});return n.jsx(_,{theme:a,children:n.jsx(W,{rows:e,theme:a,ref:c,onChange:u,autoFocus:t==null?void 0:t.autoFocus,defaultValue:t==null?void 0:t.defaultValue,disabled:t==null?void 0:t.disabled,placeholder:t==null?void 0:t.placeholder,readOnly:t==null?void 0:t.readOnly,required:t==null?void 0:t.required,value:t==null?void 0:t.value})})}Object.assign(Ye,{Box:_,Root:W,hook:pe});const ve={surface:"var(--tooltip-surface, #616161EA)"},Y=m("tooltip"),xe=()=>{const e=o.useRef(null),r=o.useRef(null),[a,l]=o.useState(!1);return o.useLayoutEffect(()=>{if(!a||!(e!=null&&e.current)||!(r!=null&&r.current))return;const{top:s,left:t,height:c,width:u}=e.current.getBoundingClientRect(),{width:d}=r.current.getBoundingClientRect(),p=t-d/2+u/2,b=s+c+window.scrollY;r.current.setAttribute("style",`transform: translate(${p}px, ${b}px)`)},[a]),{containerRef:e,boxRef:r,show:a,setShow:l}},ke=i.span.attrs({className:Y("container")})`
  position: relative;
  display: inline-block;
...
`;X.defaultProps={theme:ve};function Xe({children:e,title:r,theme:a=ve}){const{boxRef:l,containerRef:s,show:t,setShow:c}=xe();return n.jsxs(ke,{ref:s,onMouseOver:()=>{c(!0)},onMouseLeave:()=>{c(!1)},onClick:()=>{c(!t)},children:[e,t?Ce.createPortal(n.jsx(ye,{ref:l,children:n.jsx(X,{"data-placement":"bottom",theme:a,children:r})}),document.body):null]})}const Qe=Object.assign(Xe,{Container:ke,Box:ye,Text:X,Hooks:xe});export{Je as B,Ke as C,Qe as T};
