import{r as h,j as r,C as Z,a as v,B as ee,T as re,u as c,R as u,A as te,G as ae,I as ne,L as ie,M as O,b as se,c as y,d as R,e as z,l as E,f as oe,D as ce,F as le,S as de,g as me,h as ue,i as pe,k as L,P as Y,m as j,n as he,o as xe,p as fe,q as D,s as B,t as be,v as ge,w as G,x as we,y as Ae}from"./index-inyV_Q9P.js";const Se=({children:e,title:t})=>{const n=h.useRef(null),a=h.useRef(null),[i,o]=h.useState(!1);return h.useLayoutEffect(()=>{if(!i||!(n!=null&&n.current)||!(a!=null&&a.current))return;const{top:l,left:x,height:m,width:p}=n.current.getBoundingClientRect(),{width:b}=a.current.getBoundingClientRect(),f=x-b/2+p/2,g=l+m+window.scrollY;a.current.setAttribute("style",`transform: translate(${f}px, ${g}px)`)},[i]),r.jsxs(Z,{ref:n,onMouseOver:()=>{o(!0)},onMouseLeave:()=>{o(!1)},onClick:()=>{o(!i)},children:[e,i?v.createPortal(r.jsx(ee,{ref:a,children:r.jsx(re,{"data-placement":"bottom",children:t})}),document.body):null]})},Re=c(O).attrs({className:"ui-exlink-iconbtn"})`
  padding: 0.25rem;
  width: 2rem;
  height: 2rem;
`,Ce=({to:e,children:t})=>r.jsx(ie,{to:e,children:r.jsx(Re,{variant:"line",children:t})}),ye=c.div.attrs({className:"ui-exlink-groupcontainer"})`
  display: flex;
...
`,Ne=()=>{const e=u.useRef([{to:"https://arca.live/b/azurlane/45593816",render:r.jsx(te,{})},{to:"https://github.com/gateisbug/alit",render:r.jsx(ae,{})},{to:"https://azurlane.koumakan.jp/wiki/Azur_Lane_Wiki",render:r.jsx(ne,{})}]);return r.jsx(ye,{children:e.current.map(t=>r.jsx(Ce,{to:t.to,children:t.render},t.to))})},je=u.memo(Ne),Te=c.header.attrs({className:"ui-header-root"})`
...
`,Ee=()=>{const e=u.useRef(null);return u.useEffect(()=>{const t=window.innerWidth-document.documentElement.clientWidth;e&&e.current&&(e.current.style.minWidth=`calc(100vw - ${t}px);`)},[]),r.jsx(Te,{ref:e,children:r.jsxs(ke,{className:"max-wrap",children:[r.jsx(se,{}),r.jsx(je,{})]})})};c.div.attrs({className:"ui-wrap-root"})`
  max-width: 1600px;
  width: 100%;
...
`,Ie=c.form.attrs({className:"ui-itemfilter-list"})`
  ...
  gap: 0.5rem;
  padding: 0.5rem 0;
`,Pe=()=>{const e=u.useRef(null),t=u.useRef(null),n=R(_),a=z().category??"all",[i,o]=u.useState(!1);u.useEffect(()=>{o(!1)},[a]);const l=u.useCallback(E.debounce(()=>{switch(!0){case a===d.GUN:return w.GUN;case a===d.TORPEDO:return w.TORPEDO;case a===d.ANTIAIR:return w.ANTIAIR;case a===d.AIRCRAFT:return w.AIRCRAFT;case a===d.ACCESSORY:return w.ACCESSORY;case a===d.SPECIAL:return w.SPECIAL;default:return w.ALL}},200),[a]),x=u.useCallback(E.debounce(()=>{const p=document.querySelectorAll('input[type="checkbox"][name="category"]'),b=[];for(let f=0;f<p.length;f++){const g=p[f];g.checked&&b.push(g.value)}n(b)},200),[]),m=u.useCallback(()=>a===d.ALL?null:r.jsx(Me,{ref:t,children:r.jsx(Ie,{children:(l()??[]).map(p=>r.jsx(oe,{name:"category",value:p.value,defaultChecked:!0,onChange:x,children:p.label},p.value))})}),[a]);return r.jsx(_e,{children:r.jsx(ce,{show:i,contents:m(),children:r.jsxs(Fe,{ref:e,variant:"text",onClick:()=>{o(!i)},disabled:a===d.ALL,className:"ff fzp fwr",children:[r.jsx(le,{}),r.jsx("span",{className:"item-span",children:"필터"})]})})})},De=u.memo(Pe),Be=()=>{const e=R(T),t=u.useCallback(E.debounce(n=>(e(n),n),500),[]);return r.jsx(de,{setValue:t})},Ge=u.memo(Be),$e=c.div.attrs({className:"ui-itemcontroller-container"})`
  display: flex;
  flex-flow: row nowrap;
  align-items: center;
  min-height: 2.25rem;
...
`,k=[{value:"link",label:"아이콘",basis:"90px",minWidth:"64px",render:e=>r.jsx(Y,{src:`images/items/${e.image}.png`,placeholder:`images/items/${e.image}_lqip.png`,stroke:K(e.type,e.domain),tier:e.tier})},{value:"name",label:"장비명",basis:"240px",minWidth:"180px"},{value:"nickname",label:"별명",basis:"150px",minWidth:"100px",render:e=>{var t,n;return(((t=e.nickname)==null?void 0:t.length)??0)>0?(n=e.nickname)==null?void 0:n.replace(/,/g,", "):"-"}},{value:"obtain",label:"획득처",basis:"240px",minWidth:"160px",render:e=>{var t;return r.jsx(qe,{children:(t=Xe(e))==null?void 0:t.map((n,a,i)=>i.length>2&&n.includes("메인")?null:r.jsx("span",{children:n},a))})}},{value:"nation",label:"국가",basis:"100px",minWidth:"60px"},{value:"class",label:"구분",basis:"100px",minWidth:"60px",render:e=>J(e)},{value:"type",label:"종류",basis:"100px",minWidth:"60px",render:e=>X(e)},{value:"explain",label:"설명",basis:"468px",minWidth:"200px",render:e=>{var t;return r.jsx(Ze,{children:(t=e.explain)==null?void 0:t.join(". ")})}}],er=async e=>{const t=async n=>await Ke(`/alit/json/${n}.json`)??[];if(e!=="all")return await t(e);{const n=[d.GUN,d.TORPEDO,d.ANTIAIR,d.AIRCRAFT,d.ACCESSORY];let a=[];for(let i=0;i<n.length;i++){const o=await t(n[i]);a=a.concat(o)}return a}},rr=({columns:e=[]})=>r.jsx(F,{className:"table-header",children:r.jsx(Q,{children:e.map(t=>r.jsx(q,{style:{flexBasis:t.basis,minWidth:t.minWidth},"data-type":"th",className:"ff fzp fwb fcs",children:t.label},t.value))})}),tr=({columns:e=[],items:t=[]})=>{const n=R(V),a=R(H),i=j(T),o=h.useCallback(l=>{n(!0),a(l)},[]);return r.jsxs(F,{className:"table-body",children:[t.map((l,x)=>r.jsx(Q,{"data-type":"row",onClick:()=>{o(l)},children:e.map(m=>r.jsx(q,{style:{flexBasis:m.basis,minWidth:m.minWidth},"data-type":"td","data-key":m.value,className:"ff fzp fwr fc",children:m.render?m.render(l):l[m.value]},`${l.name}_${x}_${m.value}`))},`${l.name}_${x}`)),i.length>0&&((t==null?void 0:t.length)??0)===0?r.jsxs(ve,{children:[r.jsx("p",{children:"\\(o_o)/"}),r.jsx("p",{children:"No Search Data"})]}):null]})},ar=()=>{const e=j(W),t=j(_),n=j(T),{isDesktop:a,isTablet:i,isMobile:o}=Ve(),l=h.useMemo(()=>o?k.filter(m=>["link","name","class","explain"].includes(m.value)):i?k.filter(m=>["link","name","obtain","class","type","explain"].includes(m.value)):k,[a,i,o]),x=h.useMemo(()=>{let m=e;return m.length===0?[]:(t.length>0&&(m=t.length===0?m:m.filter(p=>t.includes(p.class??""))),n.length>0&&(m=m.filter(p=>{var b,f,g,I,P;return((b=p.name)==null?void 0:b.includes(n))||((f=p.nickname)==null?void 0:f.includes(n))||((g=p.obtain)==null?void 0:g.join("|").includes(n))||((I=p.nation)==null?void 0:I.includes(n))||((P=p.explain)==null?void 0:P.join("|").includes(n))})),m)},[e,t,n]);return r.jsx(he,{children:r.jsxs(Qe,{children:[r.jsx(rr,{columns:l}),r.jsx(tr,{columns:l,items:x})]})})},nr=c.div.attrs({className:"ui-modal-container"})`
  display: flex;
  flex-flow: column nowrap;
  gap: 3rem;
  padding: 1.5rem;
...
`,cr=({selectedItem:e})=>{var t,n;return r.jsx(or,{children:(((t=e==null?void 0:e.explain)==null?void 0:t.length)??0)>0?(n=e==null?void 0:e.explain)==null?void 0:n.map((a,i)=>r.jsx("p",{children:a},i)):"0v0"})},lr=c(M)`
  //display: grid;
...
`,dr=({selectedItem:e})=>{var t;return r.jsx(lr,{className:"stat","data-domain":e==null?void 0:e.domain,children:(t=e==null?void 0:e.status)==null?void 0:t.map((n,a)=>{const i=n.split(":"),o=pr(i);return r.jsx(xe,{label:i[0],value:o},`modal_stat_${a}`)})})},mr=c.span`
...
`,Sr=c.div.attrs({className:"ui-table-controller"})`
  ...
  background-color: var(--surface);
  overflow-x: auto;
`,Rr=()=>{const e=z(),t=R(W),n=G(_),a=G(T);return u.useEffect(()=>{n(),a();const i=(e==null?void 0:e.category)??"all";er(i).then(o=>{t(o)}).catch(o=>{t([]),console.error(o)})},[e]),r.jsxs("div",{children:[r.jsx(Ee,{}),r.jsxs(Ar,{className:"wrap",style:{paddingBottom:"2rem"},children:[r.jsxs(Sr,{children:[r.jsx(He,{}),r.jsx(Ue,{})]}),r.jsx(ar,{})]}),r.jsx(we,{children:r.jsx(Ae,{width:"1.5rem",height:"1.5rem"})}),r.jsx(wr,{})]})},yr=Rr;export{yr as default};
