import{r as h,j as t,C as Z,a as v,B as ee,T as te,u as c,R as u,A as re,G as ae,I as ne,L as ie,M as O,b as se,c as y,d as R,e as z,l as E,f as oe,D as ce,F as le,S as de,g as me,h as ue,i as pe,k as L,P as Y,m as j,n as he,o as xe,p as fe,q as D,s as B,t as be,v as ge,w as G,x as we,y as Ae}from"./index-Azuy2MXC.js";const Se=({children:e,title:r})=>{const n=h.useRef(null),a=h.useRef(null),[i,o]=h.useState(!1);return h.useLayoutEffect(()=>{if(!i||!(n!=null&&n.current)||!(a!=null&&a.current))return;const{top:l,left:x,height:m,width:p}=n.current.getBoundingClientRect(),{width:b}=a.current.getBoundingClientRect(),f=x-b/2+p/2,g=l+m+window.scrollY;a.current.setAttribute("style",`transform: translate(${f}px, ${g}px)`)},[i]),t.jsxs(Z,{ref:n,onMouseOver:()=>{o(!0)},onMouseLeave:()=>{o(!1)},onClick:()=>{o(!i)},children:[e,i?v.createPortal(t.jsx(ee,{ref:a,children:t.jsx(te,{"data-placement":"bottom",children:r})}),document.body):null]})},Re=c(O).attrs({className:"ui-exlink-iconbtn"})`
  padding: 0.25rem;
  width: 2rem;
  height: 2rem;
...
`,Ue=()=>t.jsxs($e,{children:[t.jsx(Ge,{}),t.jsx(De,{})]}),ze=c.div.attrs({className:"item-fitbox"})`
  width: fit-content;
  min-width: 28.75rem;
