const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/page-B9t7fhTJ.js","assets/index-KU5EZYpv.js","assets/index-EHUB-4pU.css","assets/modal-CCYW3Z22.js","assets/modal.style-B0lhKyIK.js","assets/useInfiniteGrid-DlikdUSy.js","assets/styled-DsWCmJbP.js"])))=>i.map(i=>d[i]);
var P=(l,n,a)=>new Promise((o,e)=>{var t=c=>{try{r(a.next(c))}catch(v){e(v)}},s=c=>{try{r(a.throw(c))}catch(v){e(v)}},r=c=>c.done?o(c.value):Promise.resolve(c.value).then(t,s);r((a=a.apply(l,n)).next())});import{d as _,L as V,j as d,u as E,r as $,_ as K,a as W}from"./index-KU5EZYpv.js";import{L as Y}from"./styled-DsWCmJbP.js";import{P as J,h as N,u as Q,a as X}from"./useInfiniteGrid-DlikdUSy.js";const Z=_.div.attrs({className:"flex column"})`
  user-select: none;
`,ee=_.div.attrs({className:"flex"})`
  gap: 16px;
`,ae=_.div.attrs({className:"bb"})`
  box-sizing: border-box;
  flex-grow: 1;
`,le=_(Z)``,i=_(ae).attrs({className:"flex ai-c"})`
  min-height: 64px;
`,T=_(ee)`
