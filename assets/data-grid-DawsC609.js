const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/page-C9QgGD6a.js","assets/index-ChMF3pDD.js","assets/index-EHUB-4pU.css","assets/modal-XMlwBMbW.js","assets/modal.style-iti0qITP.js","assets/useInfiniteGrid-M0VrA4mv.js","assets/styled-r_aVcFgP.js"])))=>i.map(i=>d[i]);
var C=(l,n,a)=>new Promise((t,e)=>{var s=d=>{try{o(a.next(d))}catch(r){e(r)}},b=d=>{try{o(a.throw(d))}catch(r){e(r)}},o=d=>d.done?t(d.value):Promise.resolve(d.value).then(s,b);o((a=a.apply(l,n)).next())});import{d as _,j as u,u as I,r as $,_ as G,a as z}from"./index-ChMF3pDD.js";import{L as B}from"./styled-r_aVcFgP.js";import{P as D,h as k,u as q,a as U}from"./useInfiniteGrid-M0VrA4mv.js";const V=_.div.attrs({className:"flex column"})`
  user-select: none;
`,K=_.div.attrs({className:"flex"})`
  gap: 16px;
`,W=_.div.attrs({className:"bb"})`
  box-sizing: border-box;
  flex-grow: 1;
`,Y=_(V)``,i=_(W).attrs({className:"flex ai-c"})`
  min-height: 64px;
`,T=_(K)`
