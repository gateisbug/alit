import{r as h,j as r,C as Z,a as v,B as ee,T as re,u as c,R as u,A as ae,G as te,I as ne,L as ie,M as O,b as se,c as y,d as R,e as z,l as E,f as oe,D as ce,F as le,S as de,g as me,h as ue,i as pe,k as L,P as Y,m as j,n as he,o as fe,p as xe,q as D,s as B,t as be,v as ge,w as G,x as we,y as Ae}from"./index-SK-RYtOh.js";const Se=({children:e,title:a})=>{const n=h.useRef(null),t=h.useRef(null),[i,o]=h.useState(!1);return h.useLayoutEffect(()=>{if(!i||!(n!=null&&n.current)||!(t!=null&&t.current))return;const{top:l,left:f,height:m,width:p}=n.current.getBoundingClientRect(),{width:b}=t.current.getBoundingClientRect(),x=f-b/2+p/2,g=l+m+window.scrollY;t.current.setAttribute("style",`transform: translate(${x}px, ${g}px)`)},[i]),r.jsxs(Z,{ref:n,onMouseOver:()=>{o(!0)},onMouseLeave:()=>{o(!1)},onClick:()=>{o(!i)},children:[e,i?v.createPortal(r.jsx(ee,{ref:t,children:r.jsx(re,{"data-placement":"bottom",children:a})}),document.body):null]})},Re=c(O).attrs({className:"ui-exlink-iconbtn"})`
  padding: 0.25rem;
  width: 2rem;
  height: 2rem;
...
`,k=[{value:"link",label:"아이콘",basis:"90px",minWidth:"64px",render:e=>r.jsx(Y,{src:`images/items/${e.image}.png`,placeholder:`images/items/${e.image}_lqip.png`,stroke:K(e.type,e.domain),tier:e.tier})},{value:"name",label:"장비명",basis:"240px",minWidth:"180px"},{value:"nickname",label:"별명",basis:"150px",minWidth:"100px",render:e=>{var a,n;return(((a=e.nickname)==null?void 0:a.length)??0)>0?(n=e.nickname)==null?void 0:n.replace(/,/g,", "):"-"}},{value:"obtain",label:"획득처",basis:"240px",minWidth:"160px",render:e=>{var a;return r.jsx(qe,{children:(a=Xe(e))==null?void 0:a.map((n,t,i)=>i.length>2&&n.includes("메인")?null:r.jsx("span",{children:n},t))})}},{value:"nation",label:"국가",basis:"100px",minWidth:"60px"},{value:"class",label:"구분",basis:"100px",minWidth:"60px",render:e=>J(e)},{value:"type",label:"종류",basis:"100px",minWidth:"60px",render:e=>X(e)},{value:"explain",label:"설명",basis:"468px",minWidth:"200px",render:e=>{var a;return r.jsx(Ze,{children:(a=e.explain)==null?void 0:a.join(". ")})}}],er=async e=>{const a=async n=>await Ke(`/json/${n}.json`)??[];if(e!=="all")return await a(e);{const n=[d.GUN,d.TORPEDO,d.ANTIAIR,d.AIRCRAFT,d.ACCESSORY];let t=[];for(let i=0;i<n.length;i++){const o=await a(n[i]);t=t.concat(o)}return t}},rr=({columns:e=[]})=>r.jsx(F,{className:"table-header",children:r.jsx(Q,{children:e.map(a=>r.jsx(q,{style:{flexBasis:a.basis,minWidth:a.minWidth},"data-type":"th",className:"ff fzp fwb fcs",children:a.label},a.value))})}),ar=({columns:e=[],items:a=[]})=>{const n=R(V),t=R(H),i=j(T),o=h.useCallback(l=>{n(!0),t(l)},[]);return r.jsxs(F,{className:"table-body",children:[a.map((l,f)=>r.jsx(Q,{"data-type":"row",onClick:()=>{o(l)},children:e.map(m=>r.jsx(q,{style:{flexBasis:m.basis,minWidth:m.minWidth},"data-type":"td","data-key":m.value,className:"ff fzp fwr fc",children:m.render?m.render(l):l[m.value]},`${l.name}_${f}_${m.value}`))},`${l.name}_${f}`)),i.length>0&&((a==null?void 0:a.length)??0)===0?r.jsxs(ve,{children:[r.jsx("p",{children:"\\(o_o)/"}),r.jsx("p",{children:"No Search Data"})]}):null]})},tr=()=>{const e=j(W),a=j(_),n=j(T),{isDesktop:t,isTablet:i,isMobile:o}=Ve(),l=h.useMemo(()=>o?k.filter(m=>["link","name","class","explain"].includes(m.value)):i?k.filter(m=>["link","name","obtain","class","type","explain"].includes(m.value)):k,[t,i,o]),f=h.useMemo(()=>{let m=e;return m.length===0?[]:(a.length>0&&(m=a.length===0?m:m.filter(p=>a.includes(p.class??""))),n.length>0&&(m=m.filter(p=>{var b,x,g,I,P;return((b=p.name)==null?void 0:b.includes(n))||((x=p.nickname)==null?void 0:x.includes(n))||((g=p.obtain)==null?void 0:g.join("|").includes(n))||((I=p.nation)==null?void 0:I.includes(n))||((P=p.explain)==null?void 0:P.join("|").includes(n))})),m)},[e,a,n]);return r.jsx(he,{children:r.jsxs(Qe,{children:[r.jsx(rr,{columns:l}),r.jsx(ar,{columns:l,items:f})]})})},nr=c.div.attrs({className:"ui-modal-container"})`
  display: flex;
  flex-flow: column nowrap;
  gap: 3rem;
  padding: 1.5rem;
...
`,dr=({selectedItem:e})=>{var a;return r.jsx(lr,{className:"stat","data-domain":e==null?void 0:e.domain,children:(a=e==null?void 0:e.status)==null?void 0:a.map((n,t)=>{const i=n.split(":"),o=pr(i);return r.jsx(fe,{label:i[0],value:o},`modal_stat_${t}`)})})},mr=c.span`
