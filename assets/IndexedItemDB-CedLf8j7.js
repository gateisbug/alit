var I=Object.defineProperty;var j=Object.getOwnPropertySymbols;var R=Object.prototype.hasOwnProperty,A=Object.prototype.propertyIsEnumerable;var p=(a,t,r)=>t in a?I(a,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):a[t]=r,k=(a,t)=>{for(var r in t||(t={}))R.call(t,r)&&p(a,r,t[r]);if(j)for(var r of j(t))A.call(t,r)&&p(a,r,t[r]);return a};var w=(a,t,r)=>p(a,typeof t!="symbol"?t+"":t,r);var d=(a,t,r)=>new Promise((s,e)=>{var n=o=>{try{i(r.next(o))}catch(b){e(b)}},u=o=>{try{i(r.throw(o))}catch(b){e(b)}},i=o=>o.done?s(o.value):Promise.resolve(o.value).then(n,u);i((r=r.apply(a,t)).next())});import{r as h,j as y}from"./vendor-react-BgBXYHvm.js";import{d as m}from"./vendor-styled-components-D-sOn0X5.js";import{o as N}from"./vendor-idb-SGlR87fP.js";function O(a){const{src:t,alt:r,height:s,width:e,placeholder:n,priority:u=!1,defaultImage:i="assets/noImage.svg"}=a,[o,b]=h.useState(n!=null?n:t),g=h.useRef(null);return h.useEffect(()=>{if(!n)return;const l=new IntersectionObserver(E=>{if(E[0].isIntersecting){const x=new window.Image;x.src=t,x.onload=()=>{b(t)},l.disconnect()}},{threshold:.25});return g.current&&l.observe(g.current),()=>{g.current&&l.unobserve(g.current)}},[n,t]),y.jsx("img",{ref:g,src:o,loading:u?"eager":"lazy",onError:l=>{l.target.src=i,l.target.width=32,l.target.height=32},alt:r,width:e,height:s})}const P=m.div`
  display: flex;
